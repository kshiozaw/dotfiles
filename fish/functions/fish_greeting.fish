...
function __fish_logo \
    --description="Fish-shell colorful ASCII-art logo" \
    --argument-names outer_color medium_color inner_color mouth eye

    # defaults:
    # [ $outer_color  ]; or set outer_color  'red' ←これ(default)だとpinkになる
    [ $outer_color  ]; or set outer_color  'ff0000'
...
function fish_greeting
  # __fish_logo
  # __pokemon
  neofetch --iterm2 ~/dotfiles/neofetch/icon.png
end
